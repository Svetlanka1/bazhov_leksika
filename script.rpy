...
init:
    ...
    #$ right = Positiom (xalign=0.8, yalign=1.1)
...
#вводим имя перса
    #$ pn = renpy.input("Назовите главного героя: ", length=10, allow="йцукенгшщзхъфывапролджэячсмитьбюЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮёЁ").strip().title()
...
label check_word:
    # Просим игрока ввести название камня
    ...
    # Нормализуем строку (убираем лишние пробелы и приводим к нижнему регистру)
